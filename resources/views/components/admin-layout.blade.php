...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.statistiques.index') }}" class="nav-item {{ request()->routeIs('admin.statistiques.*') ? 'active' : '' }}">
                <span class="nav-item-left">
            ...
            <a href="{{ route('admin.journal.index') }}" class="nav-item {{ request()->routeIs('admin.journal.*') ? 'active' : '' }}">
                <span class="nav-item-left">
